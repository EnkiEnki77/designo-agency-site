...
const LocationCont = (props: Props) => {
    const locationInfo = [
        {img:'image-map-australia.png', country:'australia', office:'Designo Australia Office', address:'19 Balonne Street', city:'New South Wales 2443', phone:'(02) 6720 9092', email:'contact@designo.co'},
