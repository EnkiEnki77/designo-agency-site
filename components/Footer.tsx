...
const Footer = (props: Props) => {
  return (
    ...
    >
      <div
        className={`lg:px-[165px] px-6 md:pb-20 md:gap-y-8 md:justify-between md:px-10 flex flex-col md:flex-row md:flex-wrap bg-black gap-8 items-center ${
          props.locations ? "pt-16" : "pt-[254px] md:pt-[174px]"
        }`}
      >
        ...
        <FooterInfo className="md:order-3 ">
          <p className="text-center tracking-widest mb-2 md:mb-0 md:text-left">
