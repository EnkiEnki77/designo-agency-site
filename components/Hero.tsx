...
const Hero = (props: Props) => {
  return (
    <div className="md:px-10  lg:px-[165px] md:pt-[155px] relative">
      <div className="lg:py-[145px] lg:w-full flex flex-col lg:flex-row md:rounded-[15px] overflow-hidden md:pt-[60px] items-center mb-[120px] px-6 pt-[96px] bg-[url('../public/assets/home/desktop/bg-pattern-hero-home.svg')] bg-[left_top_12.5rem] bg-peach w-full ">
          <div className='flex flex-col items-center lg:items-start lg:px-[96px]'>
              <h1 className="lg:pr-[350px] text-center lg:text-left mt-20 md:mt-0 md:px-10 mb-[24px] lg:mb-8 md:mb-6 lg:px-0 leading-[1.1]">Award-winning custom designs and digital branding solutions</h1>
